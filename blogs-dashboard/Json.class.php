        ...
        if(!empty($upData) && is_array($upData) && !empty($id)){ 
            ...
            foreach ($data as $key => $value) { 
                if ($value['id'] == $id) { 
                    ...
                    if(isset($upData['blog_title'])){ 
                        $data[$key]['blog_title'] = $upData['blog_title']; 
                    } 
                    if(isset($upData['blog_url'])){ 
                        $data[$key]['blog_url'] = $upData['blog_url']; 
                    } 
                    if(isset($upData['category'])){ 
                        $data[$key]['category'] = $upData['category']; 
                    }
                    if(isset($upData['blog_description'])){ 
                        $data[$key]['blog_description'] = $upData['blog_description']; 
                    } 
